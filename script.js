...
function openReward(day) {
 ...
 case 1:
  ...
  “is this real?” my mind whispered,<br>
  with a vow to make things longstanding,<br>
  a message was sent,<br>
  chats brought mutual understanding,<br>
  at last, returned a sense of content.<br>
  <br>
  fate didn’t bring me back to you;<br>
  just two small words and the smile that grew.
</p>`);
      return;

    case 6:
      showReward(`<p>for you (i'm so sorry, this was VERY rushed. very ass too actually. i had a rough week, very rushed. i don't know how to draw a cat laying in doodle, i realise now that i also fucked up the hands, the rest is just incredibly shaky and looks bad overall. hope you can get a gist of the idea. hopefully next time i won't flop terribly when trying to draw for you.. atleast improvement won't be hard, right?):</p><img src="${paths.day6_image}" alt="day 6 image" />`);
      return;
